...
try {
		...
		btnBack.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				frame.dispose();
				BelharLoans loans = new BelharLoans();
				loans.frame.setVisible(true);
				
			}
		});
		btnBack.setBounds(391, 435, 89, 23);
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				if(expense>salary)
				{
					JOptionPane.showMessageDialog(null, "you are irresponsible we cannot give you a loan , you spend a lot");	
				}
